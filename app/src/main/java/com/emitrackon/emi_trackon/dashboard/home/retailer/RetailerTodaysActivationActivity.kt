...
import com.emitrackon.emi_trackon.dashboard.people.user.*
import com.emitrackon.emi_trackon.dashboard.settings.controls.ControlsActivity
import com.emitrackon.emi_trackon.databinding.ActivityRetailerTodaysActivationBinding
...
class RetailerTodaysActivationActivity : AppCompatActivity() {
    ...
    private lateinit var adapter: TodaysActivationUserAdapter
    val list = ArrayList<Dashboard.TodaysActivationn>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        adapter = TodaysActivationUserAdapter(list, this) { data, action, pos ->
            when (action) {
